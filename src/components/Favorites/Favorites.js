    ...
    render() { 
        return (
            <div className="favorites">
                ...
                {!this.props.idList && <button type="button" className="favorites__save" disabled={!this.props.favoritesTitle || !this.props.favoritesMovies} onClick={this.saveListHandler} >Сохранить в список</button>} 
